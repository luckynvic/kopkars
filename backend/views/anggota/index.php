...
<div class="anggota-index">
    ...
    $gridColumns = [
        ...
        [
           ...
           'format'=>'raw',
           'value'=>function($model, $key, $index)
           {return '<a target="_blank" href="https://api.whatsapp.com/send?phone=62'.$model->nomor_hp.'&text=Informasi%20Login%20KOPKARS%20PPK%20Kemayoran.%20URL:%20https://kopkars.pnj.ac.id/site/login%20Email:%20'.$model->email.'%20Password:%20'.$model->password_default.'%20Mohon%20segera%20reset%20password%20setelah%20Anda%20login%20pertama%20kali.%20Informasi%20lebih%20lanjut%20https://wa.me/6285212345678">Kirim WA</a>';},
        ],
